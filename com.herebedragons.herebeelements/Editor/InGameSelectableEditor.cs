...
namespace com.herebedragons.herebeelements.Editor
{
    ...
    public class InGameSelectableEditor: UnityEditor.Editor {
        ...
        private static List<InGameSelectableEditor> s_Editors = new List<InGameSelectableEditor>();
        ...
        public override void OnInspectorGUI()
        {
            ...
            var graphic = m_TargetGraphicProperty.objectReferenceValue as SpriteRenderer;
            if (graphic == null)
                graphic = (target as InGameSelectable).GetComponent<SpriteRenderer>();

            var animator = (target as InGameSelectable).GetComponent<Animator>();
            ...
            ++EditorGUI.indentLevel;
            {
                ...
                switch (trans)
                {
                    ...
                    case Selectable.Transition.SpriteSwap:
                        if (graphic as SpriteRenderer == null)
                ...
                if (EditorGUILayout.BeginFadeGroup(m_ShowAnimTransition.faded))
                {
                    ...
                    if (animator == null || animator.runtimeAnimatorController == null)
                    {
                        ...
                        {
                            var controller = GenerateSelectableAnimatorContoller((target as InGameSelectable).animationTriggers, target as InGameSelectable);
                            if (controller != null)
                            {
                                if (animator == null)
                                    animator = (target as InGameSelectable).gameObject.AddComponent<Animator>();
        ...
        private static UnityEditor.Animations.AnimatorController GenerateSelectableAnimatorContoller(AnimationTriggers animationTriggers, InGameSelectable target)
        {
            if (target == null)
                return null;
        ...
        private static string GetSaveControllerPath(InGameSelectable target)
        {
        ...
        private static string BuildAnimationPath(InGameSelectable target)
        {
        ...
        private static void StaticOnSceneGUI(SceneView view)
        {
            ...
            InGameSelectable[] selectables = InGameSelectable.allSelectablesArray;

            for (int i = 0; i < selectables.Length; i++)
            {
                InGameSelectable s = selectables[i];
        ...
        private static void DrawNavigationForSelectable(InGameSelectable sel)
        {
            if (sel == null)
                return;
