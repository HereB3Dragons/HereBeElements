...
{
    public class UIGraphicEditor : UnityEditor.Editor
    {
        ...
        protected virtual void SetShowNativeSize(bool show, bool instant)
        {
            if (instant)
        ...
        /// </summary>
        protected virtual void NativeSizeButtonGUI()
        {
        ...
        protected virtual void MaskableControlsGUI()
        {
        ...
        /// </summary>
        protected virtual void AppearanceControlsGUI()
        {
        ...
        /// </summary>
        protected virtual void RaycastControlsGUI()
        {
