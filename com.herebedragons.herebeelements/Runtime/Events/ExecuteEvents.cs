...
using BaseEventData = HereBeElements.Events.BaseEventData;
using IBeginDragHandler = HereBeElements.Events.Handlers.IBeginDragHandler;
using ICancelHandler = HereBeElements.Events.Handlers.ICancelHandler;
using IDeselectHandler = HereBeElements.Events.Handlers.IDeselectHandler;
using IDragHandler = HereBeElements.Events.Handlers.IDragHandler;
using IDropHandler = HereBeElements.Events.Handlers.IDropHandler;
using IEndDragHandler = HereBeElements.Events.Handlers.IEndDragHandler;
using IInitializePotentialDragHandler = HereBeElements.Events.Handlers.IInitializePotentialDragHandler;
using IMoveHandler = HereBeElements.Events.Handlers.IMoveHandler;
using IPointerClickHandler = HereBeElements.Events.Handlers.IPointerClickHandler;
using IPointerDownHandler = HereBeElements.Events.Handlers.IPointerDownHandler;
using IPointerEnterHandler = HereBeElements.Events.Handlers.IPointerEnterHandler;
using IPointerExitHandler = HereBeElements.Events.Handlers.IPointerExitHandler;
using IPointerUpHandler = HereBeElements.Events.Handlers.IPointerUpHandler;
using IScrollHandler = HereBeElements.Events.Handlers.IScrollHandler;
using ISelectHandler = HereBeElements.Events.Handlers.ISelectHandler;
using ISubmitHandler = HereBeElements.Events.Handlers.ISubmitHandler;
using IUpdateSelectedHandler = HereBeElements.Events.Handlers.IUpdateSelectedHandler;
...
namespace HereBeElements.Events
{
    public static class ExecuteEvents
    {
        ...
        private static readonly ExecuteEvents.EventFunction<IDeselectHandler> s_DeselectHandler = Execute;
        ...
        private static readonly ExecuteEvents.EventFunction<IMoveHandler> s_MoveHandler = Execute;
        ...
        private static readonly ExecuteEvents.EventFunction<ISubmitHandler> s_SubmitHandler = Execute;
        ...
        private static readonly ExecuteEvents.EventFunction<ICancelHandler> s_CancelHandler = Execute;
