...
namespace HereBeElements.Internal
{
        ...
        IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler
    {
      ...
      public virtual bool IsInteractable()
        ...
        void Navigate(AxisEventData eventData, InGameSelectable sel)
        {
        ...
        /// </code>
        /// </example>
        public virtual InGameSelectable FindSelectableOnLeft()
        {
        ...
        /// </code>
        /// </example>
        public virtual InGameSelectable FindSelectableOnRight()
        {
            if (m_Navigation.mode == Navigation.Mode.Explicit)
            {
        ...
        /// </code>
        /// </example>
        public virtual InGameSelectable FindSelectableOnUp()
        {
            if (m_Navigation.mode == Navigation.Mode.Explicit)
            {
        ...
        /// </code>
        /// </example>
        public virtual InGameSelectable FindSelectableOnDown()
        {
            if (m_Navigation.mode == Navigation.Mode.Explicit)
            {
