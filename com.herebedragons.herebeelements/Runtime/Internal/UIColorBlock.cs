...
namespace Internal
{
    ...
    public struct UIColorBlock : IEquatable<UIColorBlock>
    {
        ...
        [FormerlySerializedAs("highlightedColor")] [SerializeField]
        [ColorUsage(true, true)]
        ...
        [FormerlySerializedAs("m_HighlightedColor")] [SerializeField]
        [ColorUsage(true, true)]
        ...
        public static UIColorBlock FromColorBlock(ColorBlock c)
        {
            return new UIColorBlock()
            {
                colorMultiplier = c.colorMultiplier,
                disabledColor = c.disabledColor,
                fadeDuration = c.fadeDuration,
                highlightedColor = c.highlightedColor,
                normalColor = c.normalColor,
                pressedColor = c.pressedColor,
                selectedColor = c.selectedColor
            };
        }

        public static ColorBlock ToColorBlock(UIColorBlock c)
        {
